...
(function() {
  ...
  View.prototype.updateClasses = function(coords, className) {
    ...
    coords.forEach(function(coord) {
      ...
      this.$li.eq(flatCoord).addClass("snake-frame")
    }.bind(this));
  };
})();
(function() {
  ...
  Snake.prototype.move = function() {
    ...
    // Destroy snake if it eats itself and allow for wall wrapping
    if (!this.isValid()) {
      this.segments = [];
    }
  ...
  Snake.prototype.eatApple = function() {
    // check if snake has already been reset
    if(!this.head() || this.head().equals(this.board.apple.position)) {
